export const projects = [
  ...
  },
  {
    ...
    description:
      "A front-end pathfinding visualizer. Generates a random maze, then displays how the algorithms search by visualizing each iteration, and then displays the shortest path to the goal node when found. By employing powerful algorithms like Breadth-first Search and Depth-first Search, users gain a deeper understanding of pathfinding techniques through a visually engaging experience.",
    image: "./pathfinding_pic.JPG",
    code_link: "https://github.com/liam709/pathfinding",
